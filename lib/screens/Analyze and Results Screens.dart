...
import 'package:iderma/Idk_wtf.dart';
              ...
              children: <Padding>[
                ...
                Padding(
                  ...
                  child: AppBar(
                    ...
                    title: const Text('Our heart beats around 100,00 times every day or about 30 million times in a year.', 
                    maxLines: 3,
            ...
            Stack(
              ...
              children: [                  
                  ...
                  style: ButtonStyle(
                    ...
                    backgroundColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001)),
                    foregroundColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001)),
                    shadowColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001)),
                    overlayColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001)),
                    surfaceTintColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001)),
                    iconColor: MaterialStateProperty.all(Colors.black.withOpacity(0.00001))
